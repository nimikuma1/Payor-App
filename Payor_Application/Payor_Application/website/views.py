...
def receive_prior_auth_request():
    if request.method == 'POST':
        ...
        new_priorauth = Priorauth(memberID=int(prior_auth_id),memberName =' ',payor = payer,ICDCode = icd_code,procedureCode= procedure_code,priorAuthStatus = 'Submitted')  #providing the schema for the note
